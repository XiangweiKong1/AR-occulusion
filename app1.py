...
def calc_hand_data(iv, ro):
    ...
    return origin, joints, dist_x, dist_y, vert, ro
...
def main():
    ...
    hand_data_keys = ['origin', 'joints', 'distX', 'distY', 'vert', 'rotations']
    ...
    while True:
        ...
        hand_data_l = calc_hand_data(ivl, rol)
        hand_data_r = calc_hand_data(ivr, ror)
